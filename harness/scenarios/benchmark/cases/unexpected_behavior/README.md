...
"${HARNESS_ROOT:-${BENCH_WAREHOUSE_REPO}/harness}/scenarios/benchmark/cases/unexpected_behavior/scripts/run.sh"
```
...
"${HARNESS_ROOT:-${BENCH_WAREHOUSE_REPO}/harness}/scenarios/benchmark/cases/unexpected_behavior/scripts/run.sh" --via-router
```
