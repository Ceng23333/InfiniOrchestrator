...
PAYLOAD="${REPO_SVC}/InfiniOrchestrator/playground/Distribution/qwen3-32b+xiyan+9g--x203-il+x203-vllm--opt20260714/results/repro-slice-payload.json"
MODEL="${MODEL:-/data-aisoft/zenghua/models/9g_8b_thinking_llama}"
PORT="${PORT:-18080}"
LOG="${LOG:-${REPO_SVC}/InfiniOrchestrator/playground/Distribution/qwen3-32b+xiyan+9g--x203-il+x203-vllm--opt20260714/results/repro-inference-server-$(date -u +%Y%m%d-%H%M%SZ).log}"
