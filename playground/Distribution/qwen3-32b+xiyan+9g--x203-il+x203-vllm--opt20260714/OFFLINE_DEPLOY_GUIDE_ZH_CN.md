...
本文以 **零阶段（可选）+ 3 个阶段** 部署 `InfiniOrchestrator/playground/Distribution/qwen3-32b+xiyan+9g--x203-il+x203-vllm--opt20260714`：
...
```bash
CASE="/opt/offline/infinilm-metax-20260622/InfiniOrchestrator/playground/Distribution/qwen3-32b+xiyan+9g--x203-il+x203-vllm--opt20260714"
...
HELPER="$(mktemp)"
tar -xzf "${SRC_TAR}" -O \
  InfiniOrchestrator/playground/Distribution/qwen3-32b+xiyan+9g--x203-il+x203-vllm--opt20260714/bench/unpack-offline-worktree.sh \
...
test -f "${WORKSPACE}/InfiniOrchestrator/playground/Distribution/qwen3-32b+xiyan+9g--x203-il+x203-vllm--opt20260714/validate.sh"
```
...
```bash
cd "${WORKSPACE}/InfiniOrchestrator/playground/Distribution/qwen3-32b+xiyan+9g--x203-il+x203-vllm--opt20260714"
...
echo "${IMAGE_TAG}" > "${WORKSPACE}/InfiniOrchestrator/playground/Distribution/qwen3-32b+xiyan+9g--x203-il+x203-vllm--opt20260714/.image_tag"
# 直接进入第二阶段 A
```
...
CASE="${DEV_WS}/InfiniOrchestrator/playground/Distribution/qwen3-32b+xiyan+9g--x203-il+x203-vllm--opt20260714"
...
```bash
CASE="${WORKSPACE}/InfiniOrchestrator/playground/Distribution/qwen3-32b+xiyan+9g--x203-il+x203-vllm--opt20260714"
# 读模板默认值或已有 .env
...
echo "${IMAGE_TAG}" > ../../playground/Distribution/qwen3-32b+xiyan+9g--x203-il+x203-vllm--opt20260714/.image_tag
