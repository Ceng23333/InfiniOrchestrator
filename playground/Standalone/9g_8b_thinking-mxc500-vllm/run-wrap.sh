...
CONTAINER_NAME="${CONTAINER_NAME:-9g-vllm-mxc500}"
...
CONFIG_IN_CONTAINER="/workspace/InfiniOrchestrator/playground/Standalone/9g_8b_thinking-mxc500-vllm/config/master-9g_8b_thinking-vllm.toml"
