#!/usr/bin/env bash
# Build wrap image: stock vllm-mars + infini-entrypoint (no InfiniLM/InfiniCore).
set -euo pipefail
...
BUILD_CONTAINER="${BUILD_CONTAINER:-vllm-mars-entrypoint-build}"
BIN_SEED_IMAGE="${BIN_SEED_IMAGE:-}"

echo "=========================================="
echo "Build wrap image (stock vLLM + entrypoint)"
echo "=========================================="
