#!/usr/bin/env bash
# Run wrap container: infini-babysitter → stock vLLM for 9g_8b_thinking.
set -euo pipefail
...
CONFIG_IN_CONTAINER="/workspace/InfiniOrchestrator/playground/9g-vllm-babysitter/config/master-9g_8b_thinking-vllm.toml"
