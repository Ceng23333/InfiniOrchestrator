#!/usr/bin/env bash
# Post-deploy validation ladder for infinilm-metax-deployment-opt-20260714.
#
...
WORKER_CONTAINERS=(
  "infiniorch-worker-master-9g-8100-20260714"
  "infiniorch-worker-master-qwen-paged-8200-20260714"
)
