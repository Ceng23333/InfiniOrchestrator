#!/usr/bin/env bash
# Validate infinilm-metax-deployment-opt-20260714 (registry, router, master backends, optional slave)
#
# Offline smoke: probes local compose endpoints only (no HuggingFace / PyPI / registry pulls).
# Self-contained in the case pack — does not require monorepo-only paths.
# Usage: ROUTER_PORT=8800 EMBEDDING_PORT=20003 ./validate.sh localhost
...
CONTAINER_NAME="${CONTAINER_NAME:-infiniorch-master-opt-20260714}"
...
echo "=========================================="
echo "InfiniOrchestrator infinilm-metax-deployment-opt-20260714 Validation"
echo "=========================================="
